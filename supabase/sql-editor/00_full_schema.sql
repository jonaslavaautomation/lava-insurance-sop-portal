...
-- ============================================================
-- VA PORTAL ACTIVITY FEED (recent visits + most-visited company)
-- ============================================================
-- VA-facing, not admin-only - deliberately no is_admin() gate. Returns
-- ONLY a pre-masked shape (see the migration file's comment for why this
-- is two narrow SECURITY DEFINER functions rather than loosening
-- sop_views_select/profiles_select_own_or_admin): the real email is
-- masked in the SQL itself, never sent to the browser unmasked.
